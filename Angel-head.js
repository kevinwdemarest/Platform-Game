...
class Game {
    constructor() {
        ...
        this.playerImage.src = 'path/to/your/player-image.png'; // Replace with your image path
        ...
        this.player = {
            ...
            velocityY: 0,
            isJumping: false,
            direction: 'right' // Track player direction for sprite flipping
        };
    ...
    render() {
        ...
        if (this.playerImage.complete) {
            ...
            // Fallback to rectangle if image is not loaded yet
